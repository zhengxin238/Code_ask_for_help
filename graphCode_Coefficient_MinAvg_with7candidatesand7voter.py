...
voters = ['v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7']

preferences_v1 = [candidates[0], candidates[1], candidates[2], candidates[3], candidates[4], candidates[5], candidates[6]]
preferences_v2 = [candidates[1], candidates[6], candidates[3], candidates[4], candidates[2], candidates[5], candidates[0]]
preferences_v3 = [candidates[6], candidates[5], candidates[4], candidates[1], candidates[0], candidates[3], candidates[2]]
preferences_v4 = [candidates[3], candidates[2], candidates[6], candidates[0], candidates[5], candidates[1], candidates[4]]
preferences_v5 = [candidates[2], candidates[0], candidates[5], candidates[4], candidates[3], candidates[6], candidates[1]]
preferences_v6 = [candidates[4], candidates[5], candidates[3], candidates[6], candidates[1], candidates[0], candidates[2]]
preferences_v7 = [candidates[2], candidates[0], candidates[6], candidates[5], candidates[3], candidates[4], candidates[1]]

preference_in_table = [preferences_v1, preferences_v2, preferences_v3, preferences_v4, preferences_v5, preferences_v6,preferences_v7]
