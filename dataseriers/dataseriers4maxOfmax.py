...
from basic_functions import prefLibParse, function_code
import numpy as np
...
db = client['votingdb']
collection = db['MaxOMax00009-00000001']
# =====================================================
...
directory = r"D:\data_collections_preflib\Max_Max"


def getResultIntoDB_maxOfmax_graphnnormal_diff_committeesize_p(p_list, committee_size_list, candidates, voters,
...
getResultIntoDB_maxOfmax_graphnnormal_diff_committeesize_p(p_list, committee_size_list, candidates, voters,
...
# # =====================================================
# coeff = graphCode_Coefficient_MaxOfMax.getCoefficientMatrix(df_bordaScore)
# # =====================================================
# result_dict = gb_maxOfMax.maxOfMax_model_run_optimization(len(candidates), coeff, committee_size)
#
# # =====================================================f1
# result_dict = gb_maxOfMax.maxOfMax_model_run_optimization(len(candidates),
#                                                          graphCode_Coefficient_MaxOfMax.getCoefficientMatrix(
